 ...
 * post验证类
 *
 * @package    library* www.yifanjie.com Jason
 */
...
Class Validate{
     ...
     * @param bool $require
     */
    public function setDefaultValidate($input, $validator, $message, $require=true)
    {
        $validateparam = [
            'input' => $input,
            'validator' => $validator,
        ...
        $this->setValidate($validateparam);
    }
     ...
     * @param $message
     */
	public function setCustomValidate($input, $regexp, $message,  $require=true)
    {
        $validateparam = [
            'input' => $input,
            'validator' => 'custom',
     ...
     * @param bool $require
     */
    public function setCompareValidate($input, $operator, $to, $message, $require=true)
    {
        $validateparam = [
            'input' => $input,
            'validator' => 'compare',
     ...
     * @param bool $require
     */
    public function setLengthValidate($input, $min, $max='', $message, $require=true)
    {
        $validateparam = [
            'input' => $input,
            'validator' => 'length',
