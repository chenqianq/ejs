    ...
    <form method="post" class="layui-form" >
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="gname" lay-verify="title" value="<?php echo $groupInfo['admin_group_name'] ?>" placeholder="请输入用户组名称" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-tab">
        ...
        foreach ($limitArray as $site => $siteGroup) { ?>
            ...
            foreach ($siteGroup as $leftMenu){ ?>
                <table class="layui-table">
                    ...
                    <thead>
                    <tr id="<?php echo $leftMenu["topRouteName"]; ?>">
                        ...
                        <tr>
                            <td style="padding-left: 50px;">
                                ...
                                foreach ($childRouteArray as $childRoute){
                                    $checked = "";
                                    if(in_array($childRoute["id"],$limitIds)){
                                        $checked = "checked";
                                    }
                                    echo "<input title=\"".$childRoute["desc"]."\" $checked name=\"permission_id[]\" value=\"".$childRoute["id"]."\" lay-skin=\"primary\" lay-filter=\"choose\" type=\"checkbox\"/>";
                                } ?>
                            </td>
                        </tr>
                    <?php   }
