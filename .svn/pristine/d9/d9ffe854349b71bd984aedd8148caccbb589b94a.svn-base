...
class ZcConfig {
	...
	public function __construct() {
		$this->config = array (
				...
				ZcConfigConst::MonitorDbUsername => 'db_dev',
				ZcConfigConst::MonitorDbPassword => 'db_dev',
				ZcConfigConst::MonitorDbDatabase => 'db_dev',
				ZcConfigConst::MonitorExitOnDbError => true,
				
				ZcConfigConst::LogDir => '/tmp/zc/',
				ZcConfigConst::LogLevel => ZcLog::INFO,
                ZcConfigConst::LogHandlerLogstashredisEnable => false,
