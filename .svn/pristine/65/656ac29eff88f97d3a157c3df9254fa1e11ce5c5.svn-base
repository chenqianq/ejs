...
class ServiceFactory
{
     ...
     * GoodsService
	 * @param bool $singleton
	 * @param array $parameterArray [merchantId 商户id]
	 * @return GoodsService
	 */
	public static function getGoodsService($singleton = true, $parameterArray=[])
	{
		return self::innerGetService('goods', 'GoodsService', $singleton, $parameterArray);
	}
